...
def training_process(args):
    ...
    model = model_dir[args.model_type](img_size=image_size, in_chans=3, num_classes=101)
...
def main(args, rank, world_size):
    ...
    search_space = ['batch_size', 'patch_size', 'image_size', 'model_type', 'num_shearlet_channels']
